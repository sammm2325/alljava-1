...
public class RowMajor {
	public static void main(String[] args) {
      ...
      double averageVal = runnerTime / times[0].length; //This modification calculates the average time for each runner by dividing the runnerTime by the number of lap times (times[0].length). The results are printed for each runner.
